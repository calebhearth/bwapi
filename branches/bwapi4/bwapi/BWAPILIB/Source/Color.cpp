...
#define _BW_NONE 0xFFFFFFFF

namespace BWAPI
{
  bool rgbInitialized = false;
  static const unsigned int palette[256] = {  0x000000, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE,
                        _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE,
                        ...
                        _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE,
                        _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE,
                        _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, _BW_NONE, 0xffffff
                      };
  namespace Colors
  {
